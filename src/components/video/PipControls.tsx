...
export default function PipControls(props: PipControlsProps) {
	...
	const mouseDown = (e: MouseEvent) => {
		// Do not hijack clicks on interactive elements (buttons, anchors, inputs, etc.)
	...
	return (
		<div
			class="absolute inset-0 flex h-full w-full items-center justify-center bg-transparent transition-opacity duration-300"
			classList={{
				"opacity-0": !isVisible(),
